#ifndef CDSLIB_CONTAINER_WF_PRIMITIVES_H
#define CDSLIB_CONTAINER_WF_PRIMITIVES_H
...
namespace cds { namespace container { namespace wf_primitives { 
static inline int
...
#define CAS(ptr, expected, desired) \
  ::cds::container::wf_primitives::_compare_and_swap((void **) (ptr), (void **) (expected), (void *) (desired))
#define CAScs CAS
#define CASra CAS
#define CASa  CAS
...
#endif // CDSLIB_CONTAINER_WF_PRIMITIVES_H
