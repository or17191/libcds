...
#   endif
    ...
    /** @ingroup cds_nonintrusive_queue
        It is non-intrusive version of basket queue algorithm based on intrusive::HTMBasketQueue counterpart.
        ...
        - \p Traits - queue traits, default is \p basket_queue::traits. You can use \p basket_queue::make_traits
            ...
            typedef cds::container::HTMBasketQueue< cds::gc::HP, Foo, myTraits > myQueue;
    ...
    */
...
#else
        protected details::make_htm_basket_queue< GC, T, Traits >::type
#endif
    {
        //@cond
        typedef details::make_htm_basket_queue< GC, T, Traits > maker;
    ...
    public:
        ...
        /**
            ...
            and then it calls \p intrusive::HTMBasketQueue::enqueue().
        ...
        */
        ...
        /**
            ...
            \code
            cds::container::HTMBasketQueue< cds::gc::HP, Foo > myQueue;
            Bar bar;
        ...
        */
        ...
        /** \copydetails cds::intrusive::HTMBasketQueue::size()
        */
        size_t size() const
        {
