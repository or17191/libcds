...
namespace {
    ...
    class IntrusiveHTMBasketQueue_HP : public cds_test::intrusive_msqueue
    {
    ...
    protected:
        ...
        void SetUp()
        {
            typedef ci::HTMBasketQueue< gc_type, base_item_type > queue_type;
    ...
    TEST_F( IntrusiveHTMBasketQueue_HP, base_hook )
    {
        typedef cds::intrusive::HTMBasketQueue< gc_type, base_item_type,
            typename ci::basket_queue::make_traits<
                ci::opt::disposer< mock_disposer >
    ...
    TEST_F( IntrusiveHTMBasketQueue_HP, base_item_counting )
    {
        typedef cds::intrusive::HTMBasketQueue< gc_type, base_item_type,
            typename ci::basket_queue::make_traits<
                ci::opt::disposer< mock_disposer >
    ...
    TEST_F( IntrusiveHTMBasketQueue_HP, base_stat )
    {
        ...
        typedef cds::intrusive::HTMBasketQueue< gc_type, base_item_type, traits > test_queue;
    ...
    TEST_F( IntrusiveHTMBasketQueue_HP, member_hook )
    {
        typedef cds::intrusive::HTMBasketQueue< gc_type, member_item_type,
            typename ci::basket_queue::make_traits<
                ci::opt::disposer< mock_disposer >
    ...
    TEST_F( IntrusiveHTMBasketQueue_HP, member_hook_stat )
    {
        struct traits : public ci::basket_queue::traits
        {
        ...
        typedef cds::intrusive::HTMBasketQueue< gc_type, member_item_type, traits > test_queue;
